...
namespace VkLikeSiteBot.Infrastructure
{
    ...
    {
        private Regex _vkCsrfRegexp = new Regex(@"name=""(.+)"" value=""(.+)""");  
        private Regex _approvementRegexp = new Regex(@"action=\""(.+)"">");        
        private Regex _tokenRegexp = new Regex(@"token = '(.+)'");                  
        ...
        {
            MatchCollection matches = _vkCsrfRegexp.Matches(html);
        ...
        {
            Match match = _approvementRegexp.Match(html);
        ...
        {
            MatchCollection matches = _tokenRegexp.Matches(html);
